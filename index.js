    ...
    <Box flexDirection="column" paddingLeft={2}>
        {resumeData.certifications.map(cert => (
            <Box key={cert.name} flexDirection="column" marginBottom={1}>
                <Text bold color="greenBright">{cert.name}</Text>
                <Text color="cyan">{cert.issuer}</Text>
                <Text color="gray">  {cert.detail}</Text>
            </Box>
        ))}
    </Box>
);
...
const ContactSection = () => (
    <Box flexDirection="column" paddingLeft={2}>
        ...
        <Newline />
        <Text color="gray">Open to CEH internship and beginner cybersecurity opportunities.</Text>
    </Box>
);
...
const App = () => {
    ...
    const items = [
        ...
        { label: 'LEARNING LOG', value: 'experience' },
        { label: 'PRACTICE NOTES', value: 'projects' },
        { label: 'SKILLS MATRIX', value: 'skills' },
        ...
        <Box flexDirection="column" margin={2} padding={1} borderStyle="round" borderColor="magenta">
            ...
            <Box flexDirection="row" marginBottom={1} alignItems="flex-start">
                ...
                <Box flexDirection="column" flexGrow={1} justifyContent="center" paddingTop={1}>
                    <Text bold>{cyberpunkGradient("SHAURYA HARKAR // CEH INTERN CANDIDATE")}</Text>
                    <Text color="gray">System Status: LEARNING MODE. Offline rendering complete.</Text>
            ...
            <Box flexDirection="row">
                ...
                <Box width="65%" paddingLeft={2} flexDirection="column">
                    ...
                    {view === 'certifications' && <CertificationsSection />}
